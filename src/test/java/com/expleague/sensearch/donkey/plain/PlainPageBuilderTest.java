...
//              "Some text for first page",
//              Collections.singletonList("First titles"),
//              Collections.singletonList(new WikiLink("text", "First titles", 1, 5, targetUri)),
...
//              "First page subsection",
//              Arrays.asList("First titles", "Subtitle"),
//              Collections.singletonList(new WikiLink("page", "Third titles", 3, 6, targetUri)),
//              URI.create("suburi")), pageId++);
//
//      pageBuilder.addSection(
//          new WikiSection(
...
//              Arrays.asList("First titles", "Subtitle2"),
//              Arrays.asList(
//                  new WikiLink("Another", "Second titles", 2, 0, targetUri),
//                  new WikiLink("subsection", "First titles", 1, 19, targetUri)),
//              URI.create("suburi2")), pageId++);
//
//      pageBuilder.endPage();
//
...
//              Arrays.asList(
//                  new WikiLink("Second", "Second page", 2, 0, targetUri),
//                  new WikiLink("page", "First page", 1, 6, targetUri)),
...
//              Arrays.asList(
//                  new WikiLink("Third", "Third page", 3, 0, targetUri),
//                  new WikiLink("page", "Unexisting page", -1, 7, targetUri)),
